...
const NoteBooks = () => {
  ...
  const searchNotebooks = () => {
    ...
    let searchResults = orignotebooks.filter((res) =>
      res.name.toLowerCase().includes(notebookSearch.toLowerCase())
    );
      ...
      <div className="NoteBook_Page__Header">
        ...
        <div className="search_input__container">
          <input
            ...
            onChange={(e) => setNotebookSeach(e.target.value)}
          />
      ...
      <div className="Notebook__Table__Container">
        <div className="Notebook-Table-Header__Container">
          <div>
            {notebooks ? (
              <p>
                <span>{notebooks?.length}</span> notebooks
              </p>
            ) : (
              <p>notebooks</p>
            )}
