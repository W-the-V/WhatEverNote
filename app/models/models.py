...
class User(db.Model, UserMixin):
  ...
  notebooks = db.relationship("Notebook", backref='notebook', lazy=False )
...
class Notebook(db.Model):
  ...
  notes = db.relationship("Note", backref='note', lazy=False )
...
class Note(db.Model):
  ...
  tags = db.relationship("Tag", back_populates='tags', secondary="NotesToTags")
